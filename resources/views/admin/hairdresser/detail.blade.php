                                ...
                                <div class="col-lg-4 col-12 mb-4">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-small mb-2">{{__('messages.id_proof_text')}}</p>
                                            <p class="mb-3">
                                                @if($user->id_card)
                                                    <a target="_blank" href="{{url('/')}}/{{$user->id_card}}">
			                                            <img src="{{url('/')}}/{{$user->id_card}}" width="200" height="100" style="margin-top: 10px" id="image">
		                                            </a>
	                                            @else
			                                        <img src="{{url('/')}}/user/default.jpg" width="100" height="100" style="margin-top: 10px" id="image">
                                                @endif
                                            ...
                                            <p class="text-muted text-small mb-2">{{__('messages.iban_text')}}</p>
                                            <p class="mb-3">
                                                <a target="_blank" href="{{url('/')}}/{{$user->iban_card}}">Download {{__('messages.iban_text')}}</a>
                                            </p>
                                            ...
                                            <p class="text-muted text-small mb-2">{{__('messages.user_bank_name')}}</p>
                                            <p class="mb-3">
                                                {{$user->name_in_bank_account?$user->name_in_bank_account:"-"}}
                                            </p>
                                            

                                            <p class="text-muted text-small mb-2">{{__('messages.account_number')}}</p>
                                            <p class="mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="list-item-heading mb-4">{{__('messages.wallet_title')}}</p>
                                                <div class="top-right-button-container mb-2">
                                                    ...
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-outline-primary mb-2" onclick="addPopup()" <?=($user->wallet_total <= 0 ? 'disabled':'')?> >{{__('messages.add_wallet_records')}}</button>
                                                    </div>
                                                </div>
        ...
        <div class="modal fade" id="exampleModalContent" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="/admin/save-wallet-record" method="post" role="form">
                        @csrf
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <ul>
                                    <li>
                                        <label class="col-form-label">{{__('messages.here_you_can_release_only')}} <?=$user->wallet_total?> </label>    
                                    </li>
                                </ul>
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">{{__('messages.wallet_amount_text')}} : </label>
                                <input type="number" class="form-control" id="coupen_code" value='' name="amount" min="0" max="<?=$user->wallet_total?>"required>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    //alert(messages.data_table_search_placeholder_text);
