                            ...
                            <table class="data-table" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($val->image)
                                        <img src="{{url('/')}}/public/category/{{$val->image}}" width="100" height="100" style="margin-top: 10px" id="image">
                                            @else
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for=""
                                                        class="col-form-label">{{__('messages.add_parent_categories_code_text')}}</label>
