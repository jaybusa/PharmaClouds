    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.store.user')}}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="{{__('messages.add_parent_categories_name_text')}}">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">{{__('messages.email_text')}}</label>
                <div class="col-sm-10">
                    <input type="email" name="email" class="form-control" id="inputEmail3" placeholder="{{__('messages.email_text')}}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="username" class="form-control" id="inputEmail3" placeholder="{{__('messages.username_text')}}">
                </div>
            </div>
            <div class="form-group row">
