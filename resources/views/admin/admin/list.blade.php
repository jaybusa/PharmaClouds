...
<div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>{{__('messages.customer_list_text')}}</h1>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="#">{{__('messages.customer_list_text')}}</a>
                                </li>
                            </ol>
                        </nav>
                        <div class="separator mb-5"></div>
                    </div>
                    <a href="{{ route('admin.add.user') }}" class="btn btn-primary mt-3">{{ __('Add User') }}</a>
                            ...
                            <table class="data-table" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info text-white" href="{{route('admin.edit.user',['user' => $val->id])}}">{{__('messages.edit_title')}}</a>
                                            <a class="btn btn-info text-white" href="{{route('admin.delete.user',['user' => $val->id])}}">{{__('messages.delete_title')}}</a></td>
                                    </tr>
                                    @endforeach
...
<script type="text/javascript">
    ...
    $(document).on('change','.toggle_changed',function(){
        ...
        url = "{{route('admin.customer_change_status')}}";
