        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1><small><?php echo lang('edit'); ?></small> <?php echo lang('customer'); ?></h1>
                    </div>
				</div>
				<div class="row">
					<div class="col-sm-12">
				...
				<form action="#" id="editCustomerForm" method="post" onsubmit="return validateCustomerForm();">
				<div class="row form vertical-form">
					...
					<div class="col-sm-7 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="name" placeholder="<?php echo lang('full_name'); ?>" value="<?php echo $customer_data->name; ?>" required="true" />
						</div>
					</div>
					...
					<div class="col-sm-7 col-md-8">
						<div class="form-group">
							<input type="email" class="form-control" name="email" placeholder="<?php echo lang('email_id'); ?>" value="<?php echo $customer_data->email; ?>" required="true" />
						</div>
					</div>
					...
					<div class="col-sm-7 col-md-8">
						<div class="form-group">
							<input type="text" class="form-control" name="phone" placeholder="<?php echo lang('phone'); ?>" value="<?php echo $customer_data->phone; ?>"  required="true" />
					...
					<div class="col-sm-7 col-md-8">
						<div class="form-group">
							<select name="type" class="form-control chosen <?php if($config['dir']=="rtl") echo "chosen-rtl"; ?>"  required="true">
								...
								<option value="<?php echo $customer_type->id; ?>" <?php if($customer_type->id==$customer_data->type_id) echo "selected"; ?>><?php echo $customer_type->name; ?></option>
								<?php } ?>
							</select>
					...
					<div class="col-sm-7 col-md-8">
						<div class="form-group">
							...
							<label class="switch">
							  <input type="checkbox" name="status" value="1" <?php if($customer_data->status==1) echo "checked"; ?>>
							  <div class="slider round"></div>
							</label>
						</div>
					</div>
					<div class="col-md-12 submit text-center">
						<input type="submit" class="btn btn-primary" name="edit_customer_btn" value="<?php echo lang('save'); ?>" />
					</div>
                </div>
				</form>
				<hr />
