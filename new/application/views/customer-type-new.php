        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1><small><?php echo lang('new'); ?></small> <?php echo lang('customer_type'); ?></h1>
                    </div>
				</div>
				<div class="row">
					<div class="col-sm-12">
				...
				<div class="row form vertical-form">
					...
					<div class="col-md-12 submit text-center">
						<input type="submit" class="btn btn-primary" name="add_customer_type_btn" value="<?php echo lang('save'); ?>" />
					</div>
                </div>
				</form>
				<hr />
