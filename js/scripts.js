...
`;
  ...
  if(theme=='dore.light.bluenavy.min.css') {
  ...
  $("#dark").click(function(){
    theme = 'dore.dark.bluenavy.min.css';
    localStorage.setItem("dore-theme-color", theme);
  ...
  $("#language").change(function(){
    ...
    if(language=='en') {
      direction_data = 'ltr';
      localStorage.setItem("dore-direction", direction_data);
    } else {
      direction_data = 'rtl';
      localStorage.setItem("dore-direction", direction_data);
    }
    //alert(language);
    url = SITE_URL+'language/'+language;
  ...
  loadStyle(SITE_URL+"css/" + theme, onStyleComplete);
